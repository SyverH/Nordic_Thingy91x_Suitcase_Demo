...
{
    // document.getElementById("model_roll").value = event.roll;
    // document.getElementById("model_pitch").value = event.pitch;
    // document.getElementById("model_yaw").value = event.yaw;

    let roll = document.getElementById("model_roll").value;
    let pitch = document.getElementById("model_pitch").value;
    let yaw = document.getElementById("model_yaw").value;
...
window.addEventListener("DOMContentLoaded", (ev) => {
    ...
    document.getElementById("model_roll").addEventListener("input", function(event) {
        // console.log("Roll changed to ", event.target.value);
        updateOrientation();
    });

    document.getElementById("model_pitch").addEventListener("input", function(event) {
        // console.log("Pitch changed to ", event.target.value);
        updateOrientation();
    });

    document.getElementById("model_yaw").addEventListener("input", function(event) {
        // console.log("Yaw changed to ", event.target.value);
        updateOrientation();
    });
