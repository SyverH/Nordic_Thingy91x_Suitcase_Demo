...
window.addEventListener("DOMContentLoaded", (ev) => {
	...
	ws.onmessage = (event) => {
        ...
        if (accel0_chart.series[0].data.length > 1000) {
        ...
        if (accel0_chart.series[1].data.length > 1000) {
        ...
        if (accel0_chart.series[2].data.length > 1000) {
        ...
        if (gyro0_chart.series[0].data.length > 1000) {
        ...
        if (gyro0_chart.series[1].data.length > 1000) {
        ...
        if (gyro0_chart.series[2].data.length > 1000) {
